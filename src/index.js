...
app.get('/company01-01', (req, res) => {
    res.render('company01-01');
})
...
// 進入會員註冊頁面 member-book/add
app.get('/member-book/add',(req, res) => {
...
// 購物瀏覽路由
// app.get('/aroundearsony/:page?', require(__dirname + "/routes/shoplist"));
// app.get('/aroundearath/:page?', require(__dirname + "/routes/shoplist"));
// app.get('/onearsony/:page?', require(__dirname + "/routes/shoplist"));
// app.get('/onearath/:page?', require(__dirname + "/routes/shoplist"));
// app.get('/inearsony/:page?', require(__dirname + "/routes/shoplist"));
// app.get('/inearath/:page?', require(__dirname + "/routes/shoplist"));

app.use( require(__dirname + "/routes/shoplist"));


app.use('/shopcart',require(__dirname+'/routes/shopcart'));

app.use('/address-book', require(__dirname + '/routes/memberpage'));

// app.use('/address-book',require(__dirname+'/routes/address-book'));
app.use('/member-book',require(__dirname+'/routes/member-book'));
